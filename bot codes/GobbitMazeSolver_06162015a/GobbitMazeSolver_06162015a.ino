...
QTRSensorsRC qtrrc((unsigned char[]) {A1, A2, A3, A4, A5, A6, A7},
...
int pwm_a = 5;  //PWM control for motor outputs 1 and 2 is on digital pin 10  (Left motor)
int pwm_b = 6;  //PWM control for motor outputs 3 and 4 is on digital pin 11  (Right motor)
