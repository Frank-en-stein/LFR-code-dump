...
int pwm_a = 6;  //PWM control for motor outputs 1 and 2 is on digital pin 10  (Left motor)
int pwm_b = 5;  //PWM control for motor outputs 3 and 4 is on digital pin 11  (Right motor)
...
int  rightForward = 9, rightBack = 10,  leftForward = 8, leftBack = 7;

// motor tuning vars for maze navigating
int calSpeed = 90;   // tune value motors will run while auto calibration sweeping turn (0-255)
int turnSpeed = 120;  // tune value motors will run while turning (0-255)
int turnSpeedSlow = 60;  // tune value motors will run as they slow down from turning cycle to avoid overrun (0-255)
...
float kp = .04;  // tune value in follow_line() function
float kd =0.07;   // tune value in follow_line() function
//////////////////////////////////////////////////////////
int m1Speed=0;
int m2Speed=0;
int motorspeed=0;
